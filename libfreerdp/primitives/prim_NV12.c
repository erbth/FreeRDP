 ...
 *
 * NOTE:
 * This file is actually the same as prim_YUV.c for converting IYUV coded
 * images to RGB, created by and under Copyright of Marc-Andre Moreau
...
pstatus_t general_NV12ToRGB_8u_P2AC4R(const BYTE* pSrc[2], int srcStep[2],
...
{
	prims->NV12ToRGB_8u_P2AC4R = general_NV12ToRGB_8u_P2AC4R;
	
	primitives_init_NV12_opt(prims);
}
